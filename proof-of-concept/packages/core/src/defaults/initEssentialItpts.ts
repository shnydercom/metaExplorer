...
import { singleDynamicTypeDisplayCanInterpretType, PureSingleDynamicTypeDisplay } from "../components/generic";
...
export function initEssentialItpts() {
	...
	appIntRetr.addItpt(singleDynamicTypeDisplayCanInterpretType, PureSingleDynamicTypeDisplay, "cRud", [ITPT_TAG_ATOMIC]);
